...
export class ReportsConfig {
    ...
    public initStateList() {
        ...
        { value: 'IN', label: 'IN' }, { value: 'KY', label: 'KY' }, { value: 'ME', label: 'ME' },
        { value: 'MO', label: 'MO' }, { value: 'NH', label: 'NH' }, { value: 'NM', label: 'NM' },
        { value: 'NV', label: 'NV' }, { value: 'NY', label: 'NY' }, { value: 'NJ', label: 'NJ' },
        { value: 'OH', label: 'OH' }, { value: 'TN', label: 'TN' }, { value: 'TX', label: 'TX' },
        { value: 'VA', label: 'VA' }, { value: 'WI', label: 'WI' }, { value: 'WX', label: 'WX' },
        { value: 'KS', label: 'KS' }];
    }
